...
var analys_1 = __importDefault(require("./analys"));
var Crowller = /** @class */ (function () {
    function Crowller(url, analys) {
        this.url = url;
        this.analys = analys;
        this.filePath = path_1.default.resolve(__dirname, "../data/course.js");
        // 获取url内容
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        html = _a.sent();
                        fileContent = this.analys.analyze(html, this.filePath);
...
var analys = analys_1.default.getInstance();
var crowller = new Crowller(url, analys);
